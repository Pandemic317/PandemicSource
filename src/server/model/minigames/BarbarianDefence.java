...
public class BarbarianDefence {
	...
	public void spawnWave(Client c) {
		if (c != null && c.inBarbDef) {
			...
			c.sendMessage("<shad=13369497>[RAID BOT] Welcome to wave "
					+ (c.barbWave + 1) + "/25!");
	...
	public void endGame(Client c, boolean victory) {
		...
		c.sendMessage(victory ? "Congratulations, you've completed all "
				+ WAVES.length + " waves of the Raid!"
		...
		if (PlayerHandler.players[j] != null) {
    		...
    		c2.sendMessage("<col=800000000>Wave "+ c.barbWave +" has just been reached by "+ c.playerName +" in the Raid!</col>");
		}
		}
		}
	...
	public void enter(Client c) {
		...
		c.getPA().movePlayer(3169, 9757, c.playerId * 4);
		System.out
				.println("Raid Started By: " + c.playerName + "");
		c.inBarbDef = true;
		// c.barbLeader = -1;
		spawnWave(c);
	}
