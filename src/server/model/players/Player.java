...
public abstract class Player {
	...
	public String playeryelltag = "";
	public String playeryellcolor = "";
	public int Skillpoints = 0;
	public int antiqueSelect = 0;
	public long staffLogin = 0;
	public long staffLogin1 = 0;
	...
	public int ironGambler = 0;
	public int ironDeath = 0;
	public int demonsKilled = 0;
	public int nexKilled = 0;
	public int nomadKilled = 0;
	public int corpKilled = 0;
	public int chaosKilled = 0;
	public long YellTime = 0;
	public int barrelKilled = 0;
	public int avatarKilled = 0;
	public int glacorKilled = 0;
	public int HulkKills = 0;
	public int frostsKilled = 0;
	public int raidPoints = 0;
	public int thiefPoints = 0;
	public int smallRocKilled = 0;
	public int KillsNr1 = 0;
	public int KillsNr2 = 0;
	public int KillsNr3 = 0;
	public int KillsNr4 = 0;
	public int vortexSmith = 0;
	public int nationSmith = 0;
	public int captoSmith = 0;
	public int dragonboneSmith = 0;
	public int bluetorvaSmith = 0;
	public int miningPoints = 0;
	public int randomEventPoints = 0;
	public int barrowPoints = 0;
	public int godwarKilled = 0;
	public int jadKilled = 0;
	public int jadPetKilled = 0;
	public int jadMiniKilled = 0;
	...
	public int completedSetsMar, yellSet, usedOnObjectID, usedOnobjectX, usedOnobjectY, CWPlayerIndex, TrownSpellTimer;
	...
	public int KC, DC, safeTimer = 0, degradeTime, mbPoints, customPoints, PokeMini = 0, PkminiPoints, pummelerPoints,
			recoil = 0, kingQuest = 0, rMQ = 0, bMQ = 0, ag1, puremaster, ag2, ag3, ag4, ag5, ag6, agilitypoints,
			headIconHints, dbowDelay = 0, pure, saveDelay, altarPrayed = 0, playerKilled, pkPoints, ImpLuck, wcLevelReq,
			totalPlayerDamageDealt, killedBy, lastChatId = 1, vestaDelay = 0, privateChat, friendSlot = 0,
			SolProtect = 0, dialogueId, gloryValue, fishingLevelReq, processPackets = 0, randomCoffin, newLocation,
			CSLS = 0, lastNpcAttacked = 0, specEffect, specBarId, processTimer, attackLevelReq, PrayLevelReq,
			fletchingLevelReq, Magic2LevelReq, strengthLevelReq, SummonLevelReq, HunterLevelReq, Dung2LevelReq,
			Con2LevelReq, CookLevelReq, WCLevelReq, StrLevelReq, RangedLevelReq, FletchLevelReq, FishLevelReq,
			Fm2LevelReq, SmithLevelReq, CraftLevelReq, MineLevelReq, HerbLevelReq, AgilLevelReq, ThievLevelReq,
			SlayLevelReq, FarmLevelReq, RCLevelReq, dungLevelReq, slayerLevelReq, Donatorreq, defenceLevelReq, dclaw1,
			dclaw2, dclaw3, dclaw4, rangeLevelReq, magicLevelReq, followId, Wheel, skullTimer, votingPoints,
			nextChat = 0, talkingNpc = -1, dialogueAction = 0, autocastId, followDistance, followId2, barrageCount = 0,
			delayedDamage = 0, delayedDamage2 = 0, pcPoints, npcKills, lizardSpawn, superPoints, isDonator, issDonator,
			WildTimer = 0, magePoints = 0, Killed = 0, Death = 0, Dicer = 0, desertTreasure = 0, lastArrowUsed = -1,
			clanId = -1, autoRet = 0, pcDamage = 0, xInterfaceId = 0, xRemoveId = 0, xRemoveSlot = 0, tzhaarToKill = 0,
			RFDToKill = 0, tzhaarKilled = 0, RFDKilled = 0, waveId, frozenBy = 0, poisonDamage = 0, teleAction = 0,
			prayerAction = 0, bonusAttack = 0, newCombat = 0;
	public String currentTime, date;
	public boolean musicOn = true;
	public boolean soundsOn = false;
	public String clanName, properName;
	public String NAME = " Pandemic Advisor";
	...
	public long lastPlayerMove, lastPoison, lastoverload, lastPoisonSip, poisonImmune, lastSpear, lastProtItem,
			...
			foodSpawn, foodDelay, emptyDelay, diceDelay, potDelay, lastspin, lastCommand, lastempty;
	...
	public String[] defaultYellTag = { "[<col=20451204>Player</col>]<shad=0>",
			"[<col=10712099>Moderator</col>]<shad=0>", "[<col=2000000000>Administrator</col>]<shad=0>",
			"[<col=800000000>Owner</col>]<shad=0>", "[<col=29184>Donator</col>]<shad=0>",
			"[<col=15692059>Super Donator</col>]<shad=0>", "[<col=800000000>Pandemic</col>]<shad=0>",
			"[<col=800000000>Pandemic</col>]<shad=0>" };
	...
	public int totalDonatorPoints = 0;
	...
	public final int[][] MAGIC_SPELLS = { { 1152, 1, 711, 90, 91, 92, 2, 5, 556, 1, 558, 1, 0, 0, 0, 0 }, // wind
																											// strike
			{ 1154, 5, 711, 93, 94, 95, 4, 7, 555, 1, 556, 1, 558, 1, 0, 0 }, // water
																				// strike
			{ 1156, 9, 711, 96, 97, 98, 6, 9, 557, 2, 556, 1, 558, 1, 0, 0 }, // earth
																				// strike
			{ 1158, 13, 711, 99, 100, 101, 8, 11, 0, 0, 0, 0, 0, 0, 0, 0 }, // fire
																			// strike
			...
			{ 12951, 74, 1978, 0, 386, 387, 23, 42, 560, 2, 554, 2, 565, 2, 556, 2 }, // smoke
																						// blitz
			{ 12999, 76, 1978, 0, 380, 381, 60, 43, 0, 0, 0, 0, 0, 0, 0, 0 }, // shadow
																				// blitz
			{ 12911, 80, 1978, 0, 374, 375, 65, 45, 560, 2, 565, 4, 0, 0, 0, 0 }, // blood
																					// blitz
			{ 12871, 82, 1978, 366, 0, 367, 70, 46, 560, 2, 565, 2, 555, 3, 0, 0 }, // ice
																					// blitz
			{ 12975, 86, 1979, 0, 0, 391, 75, 48, 560, 4, 565, 2, 556, 4, 554, 4 }, // smoke
																					// barrage
			{ 13023, 88, 1979, 0, 0, 383, 80, 49, 560, 4, 565, 2, 556, 4, 566, 3 }, // shadow
																					// barrage
			{ 12929, 92, 1979, 0, 0, 377, 85, 51, 560, 4, 565, 4, 566, 1, 0, 0 }, // blood
																					// barrage
			{ 12891, 94, 1979, 0, 0, 369, 90, 52, 560, 4, 565, 2, 555, 6, 0, 0 }, // ice
																					// barrage
			{ 13095, 97, 10518, 1853, 0, 1854, 31, 53, 563, 14, 555, 15, 0, 0, 0, 0 }, // miasmic
																						// barrage
	...
	public boolean inGambleZone() {
		if ((absX >= 2861 && absX <= 2877 && absY >= 3536 && absY <= 3557)) {
			return true;
		}
		return false;
	}
	...
	public boolean isInUndead() {
		if (absX > 2987 && absX < 2994 && absY > 9634 && absY < 9648) {
			return true;
		}
		return false;
	}
	...
	public boolean isInBarrows() {
		if ((absX >= 3540 && absX <= 3560 && absY >= 9705 && absY <= 9680)
				|| (absX >= 3540 && absX <= 3560 && absY >= 9680 && absY <= 9705)) {
		return true;
	}
	return false;
}
	...
	public boolean inMulti() {
		...
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 2630 && absX <= 2655 && absY >= 9890 && absY <= 9918) // raid minigame
				|| (absX >= 2909 && absX <= 2939 && absY >= 5189 && absY <= 5220
				|| (absX >= 3547 && absX <= 3556 && absY >= 9699 && absY <= 9690)
				|| (absX >= 3547 && absX <= 3555 && absY >= 9690 && absY <= 9699))) {
	...
	protected void appendPlayerChatText(Stream str) {
	 ...
	 public String randomMessage() {
	        ...
	        case 3:
	            return "<img=10><col=255> Did you know? We reply to every suggestion posted on forum! <img=10>";
	        }
