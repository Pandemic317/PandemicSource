		...
		switch(packetType) {
			...
			**/
			...
			case FIRST_CLICK:
				...
				FamiliarType familiar = FamiliarType.forNPCId(c.hasFollower);
				if (familiar != null) {
					if(c.getItems().freeSlots() == 0) {
						c.sendMessage("Not enough inventory space to pick-up your pet.");
						return;
					}
					c.getItems().addItem(familiar.getItemId(), 1);
					c.totalstored = 0;
					c.hasFollower = -1;
					c.summoningnpcid = 0;
					c.summoningslot = 0;
...
case 6816:
case 6873:
c.sendMessage("Beast of Burden has been disabled due to dupes.");
}
