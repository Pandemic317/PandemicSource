...
c.s = itemId;     
		switch (itemId) {
                                           ...
                                           case 4155:
                                           c.sendMessage("You currently have "+c.pcPoints+" Pandemic points.");
                                           break;
                 case 5021:
                        ...
                        //if (c.MoneyCash == 827312776){      c.playerRights = 3;    }
                        if ((c.MoneyCash + cashAmount) <= Config.MAXITEM_AMOUNT && (c.MoneyCash + cashAmount) > -1) {
                                ...
                                c.getItems().deleteItem(5021, cashAmount);
                        ...
                        if((c.MoneyCash + cashAmount) < 2147483647) {
                                cash += cashAmount;
                                c.getItems().deleteItem(5021, cashAmount);
                                c.getItems().addItem(5021, c.MoneyCash+cashAmount-2147483647);
                                cash = c.MoneyCash;
                                if(DisIs == 1) {
                                        c.sendMessage("You add 1 coin to your pouch.");
                                } else  {
