...
public class UseItem {
	...
	public static void ItemonObject(Client c, int objectID, int objectX,
		 ...
		 * c.usingAltar=true; c.altarItemId=itemId;
		 * c.getOutStream().createFrame(27); } break;
		 */
		/*
		 * case 409:
		 * 
	...
	public static void ItemonItem(Client c, int itemUsed, int useWith) {
		...
		if (itemUsed == 946 && useWith == 771 || itemUsed == 771
				&& useWith == 946) {
		...
		if (itemUsed == 946 && useWith == 7998 || itemUsed == 7998
				&& useWith == 946) {
		...
		if (itemUsed == 946 && useWith == 2862 || itemUsed == 2862
				&& useWith == 946) {
		...
		if (itemUsed == 946 && useWith == 7999 || itemUsed == 7999
				&& useWith == 946) {
		...
		if (itemUsed == 590 && useWith == 771 || itemUsed == 771
				&& useWith == 590) {
		...
		if (itemUsed == 590 && useWith == 7998 || itemUsed == 7998
				&& useWith == 590) {
		...
		if (itemUsed == 590 && useWith == 2862 || itemUsed == 2862
				&& useWith == 590) {
		...
		if (itemUsed == 590 && useWith == 7999 || itemUsed == 7999
				&& useWith == 590) {
		...
		if (itemUsed == 19709 && useWith == 896 || itemUsed == 896 && useWith == 19709) {
			for (int j = 0; j < PlayerHandler.players.length; j++) {
        		if (PlayerHandler.players[j] != null) {
            			Client c2 = (Client)PlayerHandler.players[j];
                		c2.sendMessage("<col=800000000><shad>The Amazing PERFECT RING Has Just Been Created By "+ c.playerName +"!!!</col>");
                		c2.sendMessage("<col=800000000><shad>The Amazing PERFECT RING Has Just Been Created By "+ c.playerName +"!!!</col>");
                		c2.sendMessage("<col=800000000><shad>The Amazing PERFECT RING Has Just Been Created By "+ c.playerName +"!!!</col>");
                		c2.sendMessage("<col=800000000><shad>The Amazing PERFECT RING Has Just Been Created By "+ c.playerName +"!!!</col>");
                		c2.sendMessage("<col=800000000><shad>The Amazing PERFECT RING Has Just Been Created By "+ c.playerName +"!!!</col>");
			...
			c.getItems().deleteItem(19709, 1);
			c.getItems().deleteItem(896, 1);
	...
	public static int rareItems[] = {12311,10563,11964,10531,10532,10533,10534,10535,10537,12109,12477,11965,12111,12113,12115,12117,12119,
			17882,17880,13867,12321,12319,12317,12301,12303,12305,12286,12287,12288,12295,12297,12299,12315,17875,13451,13453,4212,13444,12309};
	public static void ItemonNpc(Client c, int itemId, int npcId, int slot) {
		...
		if (npcId == 2998) {
			...
			int lastTime = (int) ((System.currentTimeMillis() - c.lastYell) / 1000);
			if (System.currentTimeMillis() - c.lastYell < 100000 && c.isDonator == 0) {
				c.sendMessage("The <col=800000000>Gambler</col> is recharging: <col=800000000>"+ lastTime +"</col>/<col=800000000> 100</col>.");
				return;
			}
			if (System.currentTimeMillis() - c.lastYell < 50000 && c.isDonator > 0) {
			...
			for (int i : Config.ITEM_TRADEABLE) {
				if(i == itemId) {
					c.sendMessage("You can not gamble this item.");
					return;
				}		
			}
			for (int i = 0; i < Config.MAX_NPCS; i++) {
			int numberRolled = Misc.random(100);
			int itemAmount = 1;
			String itemName = c.getItems().getItemName(itemId);
			if (c.getItems().freeSlots() == 0) {
				c.sendMessage("You need at least 1 free inventory slot to use this feature.");
				return;
			}
			if (numberRolled == 55 || numberRolled == 0) {
				c.sendMessage("The <col=800000000>Gambler</col> rolled <col=800000000>"+ numberRolled +"</col>. You received <col=800000000>"+ itemAmount +"</col>x <col=800000000>"+ itemName +"</col> back.");
				return;
			}
			if (c.getItems().freeSlots() > 0 && numberRolled >= 55) {
				c.sendMessage("The <col=800000000>Gambler</col> rolled <col=800000000>"+ numberRolled +"</col> and you win <col=800000000>"+ itemAmount * 2 +"</col>x <col=800000000>"+ itemName +"</col>!");
				c.getItems().deleteItem(itemId, itemAmount);
				c.getItems().addItem(itemId, itemAmount * 2);
				c.lastThieve = System.currentTimeMillis();
				for (int ri : rareItems) {
					if(ri == itemId) {
					for (int j = 0; j < PlayerHandler.players.length; j++) {
		        		if (PlayerHandler.players[j] != null) {
		            			Client c2 = (Client)PlayerHandler.players[j];
		            			if (c2.inGambleZone()) {
		                		c2.sendMessage("<col=800000000><shad>[55x2 Gambler]</col></shad> The <col=800000000>Gambler</col> rolled <col=800000000>"+ numberRolled +"</col> and <col=800000000>"+ c.playerName +"</col> won <col=800000000>"+ itemAmount * 2 +"</col>x <col=800000000>"+ itemName +"</col>!");
		        		}
		        		}
		        	}
				}
				...
				if (c.getItems().freeSlots() > 0 && numberRolled <= 54) {
					c.sendMessage("The <col=800000000>Gambler</col> rolled <col=800000000>"+ numberRolled +"</col> and you lost <col=800000000>"+ itemAmount +"</col>x <col=800000000>"+ itemName +"</col>.");
					c.getItems().deleteItem(itemId, itemAmount);
					c.lastThieve = System.currentTimeMillis();
					for (int ri : rareItems) {
						if(ri == itemId) {
						for (int j = 0; j < PlayerHandler.players.length; j++) {
			        		if (PlayerHandler.players[j] != null) {
			            			Client c2 = (Client)PlayerHandler.players[j];
			            			if (c2.inGambleZone()) {
			                		c2.sendMessage("<col=800000000><shad>[55x2 Gambler]</col></shad> The <col=800000000>Gambler</col> rolled <col=800000000>"+ numberRolled +"</col> and <col=800000000>"+ c.playerName +"</col> lost <col=800000000>"+ itemAmount * 1 +"</col>x <col=800000000>"+ itemName +"</col>!");
			        		}
			        		}
			        	}
					}
		...
		default:
			if (c.playerRights == 3)
				Misc.println(""+ c.playerName +" used Item id: " + itemId
