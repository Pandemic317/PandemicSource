...
public class Connection {
	...
	**/
	...
	public static void staffLogin(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./Data/staffLoginTime/time.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	**/
	...
	public static void addMacToBanList(Object connectedMac) {
		// TODO Auto-generated method stub
		
	}

	public static void addMacToFile(Object connectedMac) {
		// TODO Auto-generated method stub
