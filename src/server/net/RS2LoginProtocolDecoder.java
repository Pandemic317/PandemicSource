...
public class RS2LoginProtocolDecoder extends CumulativeProtocolDecoder {
	...
	private synchronized void load(final IoSession session, final int uid, final int[] cheatPackets, String name, String pass, final ISAACRandomGen inC, ISAACRandomGen outC, final int version, final int lowMem) {
